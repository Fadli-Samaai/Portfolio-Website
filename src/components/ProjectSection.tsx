...
import { fetchProjects, type ProjectWithSkills } from '../types/data'
...
export const ProjectSection = () => {
    ...
    return (
        ...
        <div className="container mx-auto max-w-5xl">
            ...
            <a className="main-button w-fit flex items-center mx-auto gap-2" href="https://github.com/Fadli-Samaai" target="_blank">
